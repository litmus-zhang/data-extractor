...
let session: { destroy: () => void; prompt: (arg0: string, arg1: { responseConstraint: { type: string; properties: { property_details: { type: string; properties: { url: { type: string; }; location: { type: string; }; latitude: { type: string; }; longitude: { type: string; }; price: { type: string; }; beds: { type: string; }; bedrooms: { type: string; }; baths: { type: string; }; bathrooms: { type: string; }; property_type: { type: string; }; features: { type: string; items: { type: string; }; }; special_features: { type: string; items: { type: string; }; }; }; }; ai_summary: { type: string; properties: { pros: { type: string; items: { type: string; }; }; cons: { type: string; items: { type: string; }; }; investment_potential: { type: string; items: { type: string; }; }; }; }; comparable_sales: { type: string; maxItems: number; items: { type: string; }; }; rental_yield_estimates: { type: string; }; price_per_square_foot_analytics: { type: string; }; }; required: string[]; additionalProperties: boolean; }; }) => any; } | null = null;
